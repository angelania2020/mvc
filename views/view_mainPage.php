                ...
                <div class="container">
                    <div class="footer-company-info d-flex flex-wrap justify-content-between mb-30-none">
                        <div class="info-single-item d-flex flex-wrap mb-30">
                            <div class="content">
                                <p>6803 Dickens Islands Apt.<br />567, PortMliew, TX 149420145</p>
                            </div>
                        </div>
                        <div class="info-single-item d-flex flex-wrap mb-30">
                            <div class="content">
                                <p>huel.simone@hotmail.com<br />dbergnaum@gmail.com</p>
                            </div>
                        </div>
                        <div class="info-single-item d-flex flex-wrap mb-30">
                            <div class="content">
                                <p>(0113) 134 9519<br />(0121) 289 6967</p>
                            </div>
                        </div>
                        <div class="info-single-item d-flex flex-wrap mb-30">
                            <div class="content">
                                <p>satday to friday 10.00 am - 5.00 pm<br />sunday closed</p>
                            </div>
                        </div>
                    </div>
                </div>
